...
class Product extends CI_Controller{
    function __construct(){
        ...
        //$this->load->model('Kategori_model','product_model');
    }
    ...
    function create(){
        ...
        $pusher = new PusherPusher(
            '5edb73018471f125ad33', //ganti dengan App_key pusher Anda
            '6910adcf0b0006388b07', //ganti dengan App_secret pusher Anda
            '1375913', //ganti dengan App_key pusher Anda
            $options
        );
