...
class Ijintelat_model extends CI_Model
{
  var $table          = 'Trans_IjinDatangTelat';
  ...
  public function generateIjinTelatNumber()
  {
    // Ambil tahun-bulan sekarang
    $yearMonth = date('Ym');
    // Prefix tetap
    $prefix    = "HRIT" . $yearMonth . "-";
    ...
    $query = $this->ABSENSI->get('Trans_IjinDatangTelat');
