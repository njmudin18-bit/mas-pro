...
class Insulating_model extends CI_Model {

  var $table          = 'Trans_JadwalKirimHD';
  var $column_order   = array('a.Id', 'a.JobDate', 'a.JobNumber', 'a.JobQuantity', 'a.Location', 'a.CreateDate', 'a.CreateBy', null);
  var $column_search  = array('a.Id', 'a.JobDate', 'a.JobNumber', 'a.JobQuantity', 'a.Location', 'a.CreateDate', 'a.CreateBy');
