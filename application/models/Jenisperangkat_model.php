...
{
  var $table          = 'Ms_JenisPerangkat';
  var $column_order   = array('Id', 'Nama', 'Deskripsi', 'Status', 'CreateDate', 'CreateBy', null);
  var $column_search  = array('Id', 'Nama', 'Deskripsi', 'Status', 'CreateDate', 'CreateBy');
  ...
  {
    $this->BJGMAS01->from($this->table);
    $this->BJGMAS01->order_by('Nama', 'ASC');
    $query = $this->BJGMAS01->get();
