...
{
  var $table          = 'Ms_SalaryDeduction';
  var $column_order   = array('DeductionName', 'DeductionType', 'Amount', 'Percentage', 'EffectiveDate', 'Period', 'IsActive', 'CreatedDate', 'CreatedBy', null);
  var $column_search  = array('DeductionName', 'DeductionType', 'Amount', 'Percentage', 'EffectiveDate', 'Period', 'IsActive', 'CreatedDate', 'CreatedBy');
  var $order          = array('DeductionID' => 'desc');
  ...
  {
    $this->ABSENSI->select("DeductionID, DeductionName, DeductionType,
                            FORMAT(Amount, 'N2', 'id-ID') AS Amount,
                            Percentage, EffectiveDate, Period, IsActive,
                            CASE 
  ...
  {
    $this->ABSENSI->from($this->table);
    $this->ABSENSI->where('DeductionID', $id);
    $query = $this->ABSENSI->get();
