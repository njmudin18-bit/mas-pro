...
{
  var $table          = 'Trans_TanggalUangMakan';
  var $column_order   = array('Date', 'IsActive', 'Notes', 'CreatedDate', 'CreatedBy', null);
  var $column_search  = array('Date', 'IsActive', 'Notes', 'CreatedDate', 'CreatedBy');
  ...
  {
    $this->ABSENSI->select("Id, Date, Notes,
                            CASE 
