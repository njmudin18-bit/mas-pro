...
<script src="<?php echo base_url(); ?>files/bower_components/raphael/js/raphael.min.js"></script>
<script src="<?php echo base_url(); ?>files/bower_components/morris.js/js/morris.js"></script>
