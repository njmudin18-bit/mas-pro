...
<script src="<?php echo base_url(); ?>assets/cdn.datatables.net/select/dataTables.select.js"></script>
<script src="<?php echo base_url(); ?>assets/cdn.datatables.net/select/select.bootstrap5.js"></script>
