  ...
  <body>
                                ...
                                <table id="order-table" class="table table-striped table-bordered table-hover" width="130%">
                                  <thead class="bg-primary text-center">
                                    <tr>
                                      ...
                                      <th class="text-center" width="7%">JOB LEVEL</th>
                                      <th class="text-center" width="7%">JOB TITLE</th>
                                      <th class="text-center" width="7%">GRADE</th>
                                      <th class="text-center" width="7%">BASIC SALARY</th>
                                      <th class="text-center" width="7%">SALARY DIVIDER</th>
                                      <th class="text-center" width="7%">DAILY SALARY</th>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="RegisterValidation">
              ...
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Job Level</label>
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                  <input type="text" name="JobTitle" id="JobTitle" class="form-control text-capitalize" required="required" autocomplete="off" placeholder="Contoh: Administration Staff">
                  <span class="help-block"></span>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type="text" name="Grade" id="Grade" class="form-control text-uppercase" maxlength="12" required="required" autocomplete="off" placeholder="Contoh: A1, B1, C1, D1">
                  <span class="help-block"></span>
                </div>
                <label class="col-sm-2 col-form-label">Basic Salary</label>
                <div class="col-sm-4">
                  <input type="text" id="BasicSalary" name="BasicSalary" class="form-control" oninput="AllowDecimalAndComma(this)" placeholder="Contoh: 5.000.000" maxlength="12" autocomplete="off">
                  <span class="help-block"></span>
                </div>
              </div>
              <div class="form-group row">
                ...
                <label class="col-sm-2 col-form-label">Salary Divider</label>
                <div class="col-sm-4">
                  <input type="text" name="SalaryDivider" id="SalaryDivider" class="form-control" oninput="AllowDecimalAndComma(this)" maxlength="12" required="required" autocomplete="off">
                  <span class="help-block"></span>
                </div>
              </div>
            </form>
    ...
    <script type="text/javascript">
      ...
      function openModal() {
        ...
        $('.help-block').empty();
        $('#modal').modal('show');
        $('.modal-title').text('Tambah Gaji Pokok');
      }
      ...
      function edit(id) {
        ...
        $.ajax({
          url: "<?php echo base_url(); ?>basic_sallary/basic_sallary_edit/" + id,
          type: "GET",
          dataType: "JSON",
          success: function(data) {
            if (data.status == 'forbidden') {
              ...
              $('[name="kode"]').val(data.BasicSalaryID);
              $('[name="JobTitle"]').val(data.JobTitle);
              $('[name="Grade"]').val(data.Grade);
              $('[name="JobLevel"]').val(data.JobLevel);
              $('[name="BasicSalary"]').val(formatRupiahDecimal(data.BasicSalary));
              $('[name="SalaryDivider"]').val(data.SalaryDivider);
      ...
      function openModalDelete(id) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: '<?php echo base_url(); ?>basic_sallary/basic_sallary_deleted/' + id,
              type: 'DELETE',
              error: function() {
      ...
      function save() {
        ...
        if (save_method == 'add') {
          url = "<?php echo base_url(); ?>basic_sallary/basic_sallary_add";
        } else {
          url = "<?php echo base_url(); ?>basic_sallary/basic_sallary_update";
        }
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable({
          ...
          "ajax": {
            "url": "<?php echo base_url(); ?>basic_sallary/basic_sallary_list",
            "type": "POST",
          },
          fixedColumns: {
            left: 3
          ...
          "aoColumns": [
            ...
            { "JOB LEVEL": "JOB LEVEL" , "sClass": "text-left", "width": "50px" },
            { "JOB TITLE": "JOB TITLE" , "sClass": "text-left", "width": "50px" },
            { "GRADE": "GRADE" , "sClass": "text-center", "width": "50px" },
            { "BASIC SALARY": "BASIC SALARY" , "sClass": "text-right", "width": "50px" },
            { "SALARY DIVIDER": "SALARY DIVIDER" , "sClass": "text-right", "width": "40px" },
            { "DAILY SALARY": "DAILY SALARY" , "sClass": "text-right", "width": "40px" },
        ...
        $("#Periode, #IsActive, #JobLevel, #JobTitle, #Grade, #BasicSalary, #EffectiveDate").change(function(){
