  ...
  <body>
                                ...
                                <table id="order-table" class="table table-striped table-bordered table-hover" width="100%">
                                  <thead class="bg-primary text-center">
                                    <tr>
                                      ...
                                      <th class="text-center" width="7%">NAMA</th>
                                      <th class="text-center" width="7%">STATUS</th>
                                      <th class="text-center" width="7%">CREATED DATE</th>
          ...
          <div class="modal-body">
            <form id="RegisterValidation">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" name="Name" id="Name" class="form-control text-capitalize" required="required" autocomplete="off" placeholder="Contoh: MESIN SD-3600">
                  <span class="help-block"></span>
                </div>
              </div>
            </form>
    ...
    <script type="text/javascript">
      ...
      function edit(id) {
        ...
        $.ajax({
          url: "<?php echo base_url(); ?>machines/machine_edit/" + id,
          type: "GET",
          dataType: "JSON",
      ...
      function openModalDelete(id) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: '<?php echo base_url(); ?>machines/machine_deleted/' + id,
              type: 'DELETE',
              error: function() {
      ...
      function save() {
        ...
        if (save_method == 'add') {
          url = "<?php echo base_url(); ?>machines/machine_add";
        } else {
          url = "<?php echo base_url(); ?>machines/machine_update";
        }
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable({
          ...
          "ajax": {
            "url": "<?php echo base_url(); ?>machines/machine_list",
            "type": "POST",
          },
          fixedColumns: {
            left: 3
          ...
          "aoColumns": [
            ...
            { "NAMA": "NAMA" , "sClass": "text-left", "width": "50px" },
            { "STATUS": "STATUS" , "sClass": "text-center", "width": "50px" },
            { "CREATED DATE": "CREATED DATE" , "sClass": "text-left", "width": "50px" },
        ...
        $("#DeptID, #IsActive, #Name").change(function(){
