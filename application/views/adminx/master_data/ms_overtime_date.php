  ...
  <body>
                                ...
                                <table id="order-table" class="table table-striped table-bordered table-hover" width="100%">
                                  <thead class="bg-primary text-center">
                                    <tr>
                                      ...
                                      <th class="text-center" width="5%">OVERTIME DATE</th>
                                      <th class="text-center" width="7%">OVERTIME NAME</th>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="RegisterValidation">
              ...
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Overtime Name</label>
                <div class="col-sm-4">
                  <input type="text" name="OvertimeName" id="OvertimeName" class="form-control text-capitalize" required="required" autocomplete="off" placeholder="Contoh: Lembur hari minggu">
                  <span class="help-block"></span>
                </div>
                <label class="col-sm-2 col-form-label">Overtime Date</label>
                <div class="col-sm-4">
                  <input type="date" name="OvertimeDate" id="OvertimeDate" class="form-control" required="required" autocomplete="off">
                  <span class="help-block"></span>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type="text" id="Amount" name="Amount" class="form-control" oninput="AllowDecimalAndComma(this)" placeholder="Contoh: 5.000" maxlength="12" autocomplete="off">
                  <span class="help-block"></span>
                </div>
    ...
    <script type="text/javascript">
      ...
      function openModal() {
        ...
        $('.help-block').empty();
        $('#modal').modal('show');
        $('.modal-title').text('Tambah Tanggal Lembur');
      }
      ...
      function edit(id) {
        ...
        $.ajax({
          url: "<?php echo base_url(); ?>ms_overtimedate/ot_date_edit/" + id,
          type: "GET",
          dataType: "JSON",
          success: function(data) {
            if (data.status == 'forbidden') {
              ...
              $('[name="OvertimeName"]').val(data.OvertimeName);
              $('[name="OvertimeDate"]').val(data.OvertimeDate);
              $('[name="Amount"]').val(formatRupiahDecimal(data.Amount));
              $('[name="IsActive"]').val(data.IsActive);
              $('[name="Notes"]').val(data.Notes);
              $('#modal').modal('show');
              $('.modal-title').text('Edit Tanggal Lembur');
              $('#btnSave').text('Update');
            }
          },
      ...
      function openModalDelete(id) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: '<?php echo base_url(); ?>ms_overtimedate/ot_date_deleted/' + id,
              type: 'DELETE',
              error: function() {
      ...
      function save() {
        ...
        if (save_method == 'add') {
          url = "<?php echo base_url(); ?>ms_overtimedate/ot_date_add";
        } else {
          url = "<?php echo base_url(); ?>ms_overtimedate/ot_date_update";
        }
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable({
          ...
          "ajax": {
            "url": "<?php echo base_url(); ?>ms_overtimedate/ot_date_list",
            "type": "POST",
          },
          fixedColumns: {
            left: 3
          ...
          "aoColumns": [
            ...
            { "OVERTIME DATE": "OVERTIME DATE" , "sClass": "text-center", "width": "50px" },
            { "OVERTIME NAME": "OVERTIME NAME" , "sClass": "text-left", "width": "50px" },
            { "AMOUNT": "AMOUNT" , "sClass": "text-right", "width": "50px" },
            { "NOTES": "NOTES" , "sClass": "text-right", "width": "150px" },
        ...
        $("#OvertimeDate, #OvertimeName, #Amount, #IsActive").change(function(){
