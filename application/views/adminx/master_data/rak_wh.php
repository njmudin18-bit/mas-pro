...
<body>
                            ...
                            <div class="card-header text-center">
                              <h5>
                                ...
                                <span class="pull-right">
                                  ...
                                  <button id="BtnPilih" type="submit" class="btn btn-danger">PILIH RAK</button>
                                </span>
                              </h5>
                            </div>
                                ...
                                <table id="example" class="table table-striped table-bordered nowrap" width="100%" border="1" cellpadding="0" cellspacing="0">
                                  <thead class="bg-primary text-center">
                                    <tr>
                                      ...
                                      <th class="text-center" width="8%">Isi</th>
        ...
        <div class="modal-body">
          <form id="RegisterValidation">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" id="Rak" name="Rak" maxlength="4" class="form-control text-uppercase" required="required" autocomplete="off" placeholder="Contoh: A, B, C dst.">
                  ...
                  <?php
                    foreach ($wh as $key => $value) {
                      ...
                      <option value="<?php echo $value->LocationID; ?>">
                        <?php echo $value->LocationID." - ".$value->Keterangan; ?>
                      </option>
                      <?php
                    }
                  ?>
            ...
            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Isi/ Baris</label>
              <div class="col-sm-10">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <textarea name="Noted" id="Noted" rows="3" class="form-control text-capitalize"></textarea>
              </div>
            </div>
          </form>
        </div>
  ...
  <script>
    ...
    function edit(id) {
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>rak/rak_edit/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
          if (data.status == 'forbidden') {
            ...
            $('[name="kode"]').val(data.data_header.Id);
            $('[name="Rak"]').val(data.data_header.Rak.trim());
            $('[name="WHLokasi"]').val(data.data_header.WHLokasi);
            $('[name="Isi"]').val(data.data_header.Isi);
            $('[name="Aktivasi"]').val(data.data_header.Status.trim());
    ...
    function openModalDelete(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            url: '<?php echo base_url(); ?>rak/rak_hapus/' + id,
            type: 'DELETE',
            error: function() {
    ...
    function save() {
      ...
      if (Isi > 0) {
        if (save_method == 'add') {
          url = "<?php echo base_url(); ?>rak/rak_add";
        } else {
          url = "<?php echo base_url(); ?>rak/rak_update";
        }
    ...
    $(document).ready(function() {
      ...
      table = $('#example').DataTable({
        ...
        "order": [],
        "ajax": {
          "url": "<?php echo base_url(); ?>rak/rak_list",
          "type": "POST",
        },
        "aoColumns": [
          {
