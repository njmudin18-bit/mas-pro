  ...
  <body>
                                ...
                                <table id="order-table" class="table table-striped table-bordered nowrap" width="125%" border="1" cellpadding="0" cellspacing="0">
                                  <thead class="bg-primary text-center">
                                    <tr>
                                      ...
                                      <th class="text-center" width="5%">DOCUMENT</th>
                                      ...
                                      <th class="text-center" width="7%">TOTAL DAY</th>
          ...
          <div class="modal-body">
            <form id="formData" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <select name="JenisID" id="JenisID" class="form-control">
                    <option value="" selected>-- Pilih --</option>
                    <?php foreach ($type_absensi as $value): ?>
                      <option value="<?= $value->Id; ?>">
                        <?= $value->AbsenceCode.' - '.htmlspecialchars($value->AbsenceName, ENT_QUOTES, 'UTF-8'); ?>
                      </option>
                    <?php endforeach; ?>
                  </select>
                  <span class="help-block"></span>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type="date" name="StartDate" id="StartDate" class="form-control" placeholder="Tanggal mulai">
                  <span class="help-block"></span>
                </div>
                <label class="col-sm-2 col-form-label">End Date</label>
                <div class="col-sm-4">
                  <input type="date" name="EndDate" id="EndDate" class="form-control" placeholder="Tanggal selesai">
                  <span class="help-block"></span>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea name="Notes" id="Notes" class="form-control" rows="3" maxlength="255" placeholder="Keterangan tambahan saat tidak masuk"></textarea>
                  <span class="help-block"></span>
                </div>
              </div>
    ...
    <script>
      ...
      function approved(AbsenceID, Status, Label) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: '<?php echo base_url(); ?>employee_absence/absence_approved',
              type: 'POST',
              data: {
                Id: AbsenceID,
                isApproved: Status
      ...
      function edit(id) {
        ...
        $.ajax({
          url: "<?php echo base_url(); ?>employee_absence/absence_edit/" + id,
          type: "GET",
          dataType: "JSON",
          success: function(data) {
            if (data.status == 'forbidden') {
              ...
              $('[name="kode"]').val(data.AbsenceID);
              $('[name="Nomor"]').val(data.Nomor);
              $('[name="DeptID"]').val(data.DEFAULTDEPTID);
              $('[name="JenisID"]').val(data.AbsenceTypeID);
              ...
              if (data.Files) {
                ...
                var embedHtml = `<embed src="<?php echo base_url(); ?>files/uploads/absensi/${data.Files}?t=${timestamp}" type="application/pdf" width="100%" height="100px" />`;
      ...
      function openModalDelete(id) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: '<?php echo base_url(); ?>employee_absence/absence_deleted/' + id,
              type: 'DELETE',
              error: function() {
                alert('Something is wrong');
                $("#loading").hide();
      ...
      function save() 
      {
        ...
        if (save_method == 'add') {
          url = "<?php echo base_url(); ?>employee_absence/absence_add";
        } else {
          url = "<?php echo base_url(); ?>employee_absence/absence_update";
        }
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable({
          ...
          "ajax": {
            "url": "<?php echo base_url(); ?>employee_absence/absence_list",
            "type": "POST",
            "data": function(data) {
              let DeptShow = [];
          ...
          "aoColumns": [
            ...
            { "DOCUMENT": "DOCUMENT" , "sClass": "text-center", "width": "50px"},
            ...
            { "START DATE": "START DATE" , "sClass": "text-center", "width": "80px" },
            { "END DATE": "END DATE" , "sClass": "text-center", "width": "80px" },
            { "TOTAL DAY": "TOTAL DAY" , "sClass": "text-center", "width": "80px" },
        ...
        $("#DeptID, #EmployeeID, #JenisID, #StartDate, #EndDate, #Notes").change(function(){
