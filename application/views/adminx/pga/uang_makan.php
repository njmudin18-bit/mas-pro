  ...
  <body>
          ...
          <div class="modal-body">
            <form id="RegisterValidation">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type="date" name="Date" id="Date" class="form-control" required="required" autocomplete="off">
              ...
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Notes</label>
                <div class="col-sm-4">
                  <input type="text" id="Notes" name="Notes" class="form-control text-capitalize" placeholder="Keterangan" maxlength="50" autocomplete="off">
                  <span class="help-block"></span>
                </div>
              </div>
            </form>
    ...
    <script type="text/javascript">
      ...
      function openModal() {
        ...
        $('.help-block').empty();
        $('#modal').modal('show');
        $('.modal-title').text('Tambah Tanggal Uang Makan');
      }
      ...
      function edit(id) {
        ...
        $.ajax({
          url: "<?php echo base_url(); ?>uang_makan/uang_makan_edit/" + id,
          type: "GET",
          dataType: "JSON",
      ...
      function openModalDelete(id) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: '<?php echo base_url(); ?>uang_makan/uang_makan_deleted/' + id,
              type: 'DELETE',
              error: function() {
      ...
      function save() {
        ...
        if (save_method == 'add') {
          url = "<?php echo base_url(); ?>uang_makan/uang_makan_add";
        } else {
          url = "<?php echo base_url(); ?>uang_makan/uang_makan_update";
        }
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable({
          ...
          "ajax": {
            "url": "<?php echo base_url(); ?>uang_makan/uang_makan_list",
            "type": "POST",
          },
          fixedColumns: {
            left: 3
          ...
          "aoColumns": [
            ...
            { "DATE": "DATE" , "sClass": "text-center", "width": "100px" },
            { "NOTES": "NOTES" , "sClass": "text-left", "width": "200px" },
        ...
        $("#Date, #Notes, #IsActive").change(function(){
