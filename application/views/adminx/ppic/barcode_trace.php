  ...
  <body>
                            ...
                            <div class="card-block special">
                              <div class="dt-responsive table-responsiveX">
                                <div class="form-group row">
                                  <label class="col-md-2 col-sm-12 col-form-label m-t-2">Filter by date</label>
                                  <div class="col-md-4 col-sm-12 m-t-2">
                                  ...
                                  <div class="col-md-3 col-sm-12 m-t-2">
                                ...
                                <table id="order-table" class="table table-striped table-bordered nowrap" width="100%" border="1" cellpadding="0" cellspacing="0">
                                  <thead>
                                    <tr class="">
                                      ...
                                      <th class="text-center bg-primary">Jlh. QR</th>
                                      ...
                                      <th class="text-center bg-primary">Inventory</th>
    ...
    <script type="text/javascript">
      $(function() {
        ...
        var start = moment(); //moment().subtract(2, 'days');
        var end   = moment();
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        table = $('#order-table').DataTable( {
          ...
          'serverMethod': 'POST',
          'ajax': {
            url : "<?php echo base_url(); ?>barcode/show_barcode_group_by_job",
            type : 'POST',
            "data": function(data) {
