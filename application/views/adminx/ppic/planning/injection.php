                                ...
                                <table id="myTable" class="table table-striped table-bordered table-hover" width="150%">
                                  <thead class="bg-primary text-white">
                                    <tr>
                                      ...
                                      <th class="text-center" colspan="4">INJECTION</th>
            ...
            <form action="" method="post" id="fgForm">
              ...
              <div id="jumlahContainer">
                <div class="form-group row mb-2 mt-3" id="jumlahRow1">
                  ...
                  <label class="col-sm-2 col-form-label">Plan Quantity</label>
                  <div class="col-sm-3 form-error mb-2">
    ...
    <script type="text/javascript">
        ...
        $.ajax({
          ...
          success: function(data) {
            if (data.status == 'forbidden') {
              ...
              //$('[name="LineName"]').val(data.first.LineName);
              ...
              data.third.forEach((item, index) => {
                let rowNumber = index + 1;
                html2 += `
                  <div class="form-group row mb-2 mt-2" id="prosesRow${rowNumber}">
                    <label class="col-sm-2 col-form-label">Tanggal</label>
                    <div class="col-sm-3 form-error mb-2">
      ...
      $(document).ready(function() {
        ...
        table = $('#myTable').DataTable({
          ...
          "ajax": {
            "url": "<?php echo base_url(); ?>planning/planning_injection_list",
            "type": "POST",
            "data": function(data) {
              let DeptShow = [];
          ...
          "aoColumns": [
            ...
            { "TANGGAL": "TANGGAL" , "sClass": "text-center", "width": "100px" }, //10
            ...
            { "CREATED DATE": "CREATE DATE" , "sClass": "text-left", "width": "150px" } //16
          ],
        ...
        $("#TanggalProduksi, #DeptID, #LineName").change(function(){
