  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      function hapus(JobNumber, TransID) 
      {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: '<?php echo base_url(); ?>wip/crimping_line_delete',
              type: 'POST',
              data: {
      ...
      function save() {
        ...
        $.ajax({
          url: "<?php echo base_url(); ?>wip/crimping_line_save",
          dataType: 'JSON',
          data: form_data,
          type: 'POST',
          beforeSend: function() {
      ...
      $(document).ready(function() {
        ...
        table = $('#myTable').DataTable({
          ...
          "ajax": {
            "url": "<?php echo base_url(); ?>wip/crimping_line_list",
            "type": "POST",
            "data": function(data) {
              let DeptShow = [];
          ...
          "aoColumns": [
            ...
            { "LINE": "LINE" , "sClass": "text-center", "width": "100px" }, 
