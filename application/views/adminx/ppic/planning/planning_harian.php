...
<html lang="en">
  ...
  <body>
                            ...
                            <div class="card-block m-b-10">
                              <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-12 m-t-3">
                                  <select name="MachineShow" id="MachineShow" class="form-control" multiple>
                              ...
                              <div class="dt-responsive table-responsive">
                                <table id="myTable" class="table table-striped table-bordered table-hover" width="125%">
                                  <thead class="bg-primary text-white">
                                    <tr>
                                      <th class="text-center" rowspan="2">NO</th>
                                      <th class="text-center" rowspan="2">PART NAME</th>
                                      <th class="text-center" rowspan="2">PART ID</th>
                                      <th class="text-center" colspan="2">PLANNING</th>
                                      ...
                                      <th class="text-center" colspan="2">DOWNTIME</th>
                                    </tr>
                                    <tr>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        table = $('#myTable').DataTable({
          ...
          "ajax": {
            "url": "<?php echo base_url(); ?>planning/planning_harian_list",
            "type": "POST",
            "data": function(data) {
              let MachineShow = [];
              $('input[name="MachineShow"]:checked').each(function () {
                if ($(this).val()) {
                  MachineShow.push($(this).val());
                }
              });

              data.tanggal  = $('#tanggal').val();
              data.mesin_id = (MachineShow.length > 0) ? MachineShow : <?php echo $DeptID; ?>;
            }
          },
          "aoColumns": [
            ...
            { "JAM": "JAM" , "sClass": "text-right", "width": "50px" },
            { "NO. JOB": "NO. JOB" , "sClass": "text-center", "width": "100px" },
            { "QTY. JOB": "QTY. JOB" , "sClass": "text-right", "width": "50px" },
            { "SISA PLAN": "SISA PLAN" , "sClass": "text-right", "width": "50px" },
            { "JAM": "JAM" , "sClass": "text-left", "width": "50px" },
            { "ALASAN": "ALASAN" , "sClass": "text-left", "width": "150px" }
          ],
    ...
    <script>
      $(function () {
        const DeptShow = $('#MachineShow').filterMultiSelect({
