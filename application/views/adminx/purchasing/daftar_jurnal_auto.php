                                ...
                                <table id="order-table" class="table table-striped table-bordered nowrap" width="100%" border="1" cellpadding="0" cellspacing="0">
                                  <thead>
                                    <tr class="">
                                      ...
                                      <th class="text-center bg-primary">Jurnal ID</th>
                                      <th class="text-center bg-primary">Nama Jurnal</th>
                                      <th class="text-center bg-primary">Ms Auto</th>
                                      <th class="text-center bg-primary">Type Inventory ID</th>
                                      <th class="text-center bg-primary">Is Asset</th>
                                      ...
                                      <th class="text-center bg-primary">Company Code</th>
                                    </tr>
                                  </thead>
                                  <tbody></tbody>
                                </table>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable( {
            ...
            'serverMethod': 'POST',
            'ajax': {
              url : "<?php echo base_url(); ?>purchasing/get_daftar_jurnal_auto",
              type : 'POST',
              "data": function(data) {
            ...
            'aoColumns': [
              ...
              { "#": "#" , "sClass": "text-center"},
              { "Jurnal ID": "Jurnal ID" , "sClass": "text-left"},
              { "Nama Jurnal": "Nama Jurnal" , "sClass": "text-left" },
              { "Ms Auto": "Ms Auto" , "sClass": "text-center" },
              { "Type Inventory ID": "Type Inventory ID" , "sClass": "text-center" },
              { "Is Asset": "Is Asset" , "sClass": "text-center" },
