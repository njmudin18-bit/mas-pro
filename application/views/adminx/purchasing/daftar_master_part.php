...
<html lang="en">
  ...
  <body>
                                ...
                                <table id="order-table" class="table table-striped table-bordered nowrap" width="100%" border="1" cellpadding="0" cellspacing="0">
                                  <thead>
                                    <tr class="">
                                      ...
                                      <th class="text-center bg-primary">Other ID</th>
                                      <th class="text-center bg-primary">Other Name</th>
                                      <th class="text-center bg-primary">Part ID Other</th>
                                      <th class="text-center bg-primary">Material</th>
                                      <th class="text-center bg-primary">Delivery</th>
    ...
    <script type="text/javascript">
      ...
      function tambahkan_data(PartID) {
        $.ajax({
          url: "<?php echo base_url(); ?>purchasing/send_master_part_data",
          method: "POST",
          data: {
            part_id: PartID
          },
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable( {
            ...
            'serverMethod': 'POST',
            'ajax': {
              url : "<?php echo base_url(); ?>purchasing/master_part_list",
              type : 'POST',
              "data": function(data) {
            ...
            'aoColumns': [
              ...
              { "Other ID": "Other ID" , "sClass": "text-left" },
              { "Other Name": "Other Name" , "sClass": "text-left" },
              { "Part ID Other": "Part ID Other" , "sClass": "text-left" },
              { "Material": "Material" , "sClass": "text-left" },
              { "Delivery": "Delivery" , "sClass": "text-left" },
