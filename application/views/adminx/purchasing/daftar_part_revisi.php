  ...
  <body>
                                ...
                                <table id="order-table" class="table table-striped table-bordered nowrap" width="100%" border="1" cellpadding="0" cellspacing="0">
                                  <thead>
                                    <tr class="">
                                      ...
                                      <th class="text-center bg-primary">Tgl</th>
                                      <th class="text-center bg-primary">No Revisi</th>
                                      <th class="text-center bg-primary">Keterangan</th>
                                      <th class="text-center bg-primary">Disetujui Oleh</th>
    ...
    <script type="text/javascript">
      ...
      function tambahkan_data(PartID) {
        $.ajax({
          url: "<?php echo base_url(); ?>purchasing/send_part_revisi_data",
          method: "POST",
          data: {
            part_id: PartID
          },
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable( {
            ...
            'serverMethod': 'POST',
            'ajax': {
              url : "<?php echo base_url(); ?>purchasing/get_daftar_part_revisi",
              type : 'POST'
            },
            ...
            'aoColumns': [
              ...
              { "No Revisi": "No Revisi" , "sClass": "text-left" },
              { "Keterangan": "Keterangan" , "sClass": "text-left" },
              { "Disetujui Oleh": "Disetujui Oleh" , "sClass": "text-left" },
              { "Aktif": "Aktif" , "sClass": "text-left" }
            ],
