...
<html lang="en">
  ...
  <body>
                                ...
                                <table id="order-table" class="table table-striped table-bordered nowrap" width="100%" border="1" cellpadding="0" cellspacing="0">
                                  <thead>
                                    <tr class="">
                                      ...
                                      <th class="text-center bg-primary">Partner ID</th>
                                      <th class="text-center bg-primary">Partner Name</th>
                                      <th class="text-center bg-primary">Type</th>
                                      <th class="text-center bg-primary">City</th>
                                      <th class="text-center bg-primary">Country</th>
                                      <th class="text-center bg-primary">Contact</th>
                                      <th class="text-center bg-primary">Phone</th>
                                      <th class="text-center bg-primary">Address</th>
                                    </tr>
                                  </thead>
                                  <tbody></tbody>
                                </table>
    ...
    <script type="text/javascript">
      ...
      function tambahkan_data(PartnerID) {
        $.ajax({
          url: "<?php echo base_url(); ?>purchasing/send_partner_data",
          method: "POST",
          data: {
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable( {
            ...
            'serverMethod': 'POST',
            'ajax': {
              url : "<?php echo base_url(); ?>purchasing/get_daftar_partner",
              type : 'POST',
              "data": function(data) {
            ...
            'aoColumns': [
              ...
              { "#": "#" , "sClass": "text-center"},
              { "Partner ID": "Partner ID" , "sClass": "text-left"},
              { "Partner Name": "Partner Name" , "sClass": "text-left" },
              { "Type": "Type" , "sClass": "text-left" },
              { "City": "City" , "sClass": "text-left" },
              { "Country": "Country" , "sClass": "text-left" },
              { "Contact": "Contact" , "sClass": "text-left" },
              { "Phone": "Phone" , "sClass": "text-left" },
              { "Address": "Address" , "sClass": "text-left" }
            ],
