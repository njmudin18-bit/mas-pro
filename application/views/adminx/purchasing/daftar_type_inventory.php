...
<html lang="en">
  ...
  <body>
                                ...
                                <table id="order-table" class="table table-striped table-bordered nowrap" width="100%" border="1" cellpadding="0" cellspacing="0">
                                  <thead>
                                    <tr class="">
                                      ...
                                      <th class="text-center bg-primary">Inventory ID</th>
                                      <th class="text-center bg-primary">Name</th>
                                      <th class="text-center bg-primary">Type Part</th>
    ...
    <script type="text/javascript">
      ...
      function tambahkan_data(TypeInventoryID) {
        $.ajax({
          url: "<?php echo base_url(); ?>purchasing/send_type_inventory_data",
          method: "POST",
          data: {
            type_inventory_id: TypeInventoryID
          },
          dataType: 'JSON',
          beforeSend: function () {
            $("#loading-screen").show();
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable( {
            ...
            'serverMethod': 'POST',
            'ajax': {
              url : "<?php echo base_url(); ?>purchasing/get_daftar_type_inventory",
              type : 'POST',
              "data": function(data) {
            ...
            'aoColumns': [
              ...
              { "#": "#" , "sClass": "text-center"},
              { "Inventory ID": "Inventory ID" , "sClass": "text-center"},
              { "Name": "Name" , "sClass": "text-left" },
              { "Type Part": "Type Part" , "sClass": "text-center" },
