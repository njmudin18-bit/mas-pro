  ...
  <body>
                              ...
                              <div class="dt-responsive table-responsive">
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-3 col-sm-12 m-t-10">
                                    <select class="form-control" name="inspector" id="inspector" required="required">
                                      <option disabled="disabled">-- Pilih --</option>
                                      <option value="All" selected="selected">All Inspector</option>
                                      <?php
                                        foreach ($QCUsers as $key => $value) {
                                          ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 m-t-20">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="RegisterValidation">
              <div id="ShowGresik" class="form-group row">
                <div class="col-sm-12 mb-2 bg-danger">
                  <h2 class="font-weight-bold text-center mt-3 mb-3">KIRIM KE GRESIK</h2>
                </div>
              </div>
              <div id="ShowKendal" class="form-group row">
                <div class="col-sm-12 mb-2 bg-warning">
                  <h2 class="font-weight-bold text-center mt-3 mb-3">KIRIM KE KENDAL</h2>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div id="show_details">
                <input type="hidden" name="scan_id_header" id="scan_id_header">
                <hr>
                <div class="form-group row">
    ...
    <script type="text/javascript">
          ...
          $.ajax({
            ...
            success: function(hasil) {
              ...
              if (hasil.status_code == 200) {
                ...
                if (hasil.data != null) {
                  if (hasil.data.scan_status == 'NG') {
                    $('#scan_id_header').val(hasil.data.scan_id);
                    $('#penyebab').val(hasil.data_details.penyebab);
                    $('#qty').val(hasil.data_details.qty);
                    $('#pic_repair').val(hasil.data_details.pic_repair);
                  ...
                  if (hasil.data.loc_result == 'WH-GRS00' || hasil.data.loc_result == 'WH-GRS01') {
                    $("#ShowGresik").show();
                    $("#ShowKendal").hide();
                  } else if (hasil.data.loc_result == 'WH-KND') {
                    $("#ShowKendal").show();
                    $("#ShowGresik").hide();
                  } else {
                    $("#ShowGresik").hide();
                  ...
                  $('#status').val("OK");
                  open_modal(barcode_no);
                  if (hasil.loc_result == 'WH-GRS00' || hasil.loc_result == 'WH-GRS01') {
                    $("#ShowGresik").show();
                    $("#ShowKendal").hide();
                  } else if (hasil.loc_result == 'WH-KND') {
                    $("#ShowKendal").show();
                    $("#ShowGresik").hide();
                  } else {
                    $("#ShowGresik").hide();
      ...
      function cari() {
        ...
        localStorage.setItem("inspector_qc", inspector);
      ...
      $(document).ready(function() {
        ...
        var inspector = localStorage.getItem("inspector_qc");
        if (inspector != null) {
