                          ...
                          <div class="card">
                            ...
                            <div class="card-block m-t-30 m-b-30">
                              ...
                              <div class="dt-responsive table-responsive">
                                <h5 class="text-center">HASIL SCAN INCOMING</h5>
                                <hr class="m-t-10 m-b-10">
          ...
          <div class="modal-body">
            <form id="RegisterValidation">
              ...
              <div id="show_details">
                ...
                <hr>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Alasan NG</label>
                  <div class="col-sm-10">
    ...
    <script type="text/javascript">
      ...
      $(function() {
        $("#scanForm").submit(function() {
          ...
          $.ajax({
            url: "<?php echo base_url(); ?>qc_incoming/cek_barcode",
            data: {
      ...
      function save_transaksi() {
        ...
        if (status == 'NG') {
          if (penyebab == '' || penyebab == null) {
            ...
            var data = $("#RegisterValidation").serialize();
            $.ajax({
              url: "<?php echo base_url(); ?>qc_incoming/save_barcode",
              data: data,
              type: 'POST',
              dataType: 'JSON',
              beforeSend: function() {
      ...
      function view_details(scan_id, job_no) {
        console.log(job_no);
        $.ajax({
          url: "<?php echo base_url(); ?>qc_incoming/view_product_ng",
          data: {
            scan_id: scan_id
          },
          type: 'POST',
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable({
          ...
          'serverMethod': 'post',
          'ajax': {
            url: "<?php echo base_url(); ?>qc_incoming/show_barcode_data_list",
            type: 'POST',
            "data": function(data) {
