 <div class="row m-2 justify-content-center">
     <div class="col-sm-2 text-center p-10  bg-primary">
         <a href="<?php echo base_url() . 'warehouse_part/page_insert_data'; ?>" class="mb-2 text-white">INPUT DATA
             PART</a>
     </div>
     ...
     <div class="col-sm-2 text-center p-10  bg-secondary">
         <a href="<?php echo base_url() . 'warehouse_part/part_fifo'; ?>" class="mb-2 text-white">PART FIFO</a>
     </div>
     <div class="col-sm-2 text-center p-10  bg-success">
         <a href="<?php echo base_url() . 'warehouse_part/sisa_mpr'; ?>" class="mb-2 text-white">SISA MPR</a>
     </div>
