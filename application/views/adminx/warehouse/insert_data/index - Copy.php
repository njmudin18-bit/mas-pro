                          ...
                          <div class="col-sm-12 mt-2">
                            <form id="trans_rack">
                              <div class="form-group row justify-content-center">
                                <label class="col-sm-2 col-form-label">Nama rack </label>
                                <div class="col-sm-2">
                                  <select name="nama_rack" id="nama_rack" class="form-control">
                                ...
                                <label class="col-sm-2 col-form-label">Nama Kolom </label>
                                <div class="col-sm-2">
                                  <select name="nama_kolom" id="nama_kolom" class="form-control">
                                    <option value="" disabled selected>-- Pilih --</option>
                                  </select>
                                  <span class="help-block"></span>
                                </div>
                                ...
                                <div class="col-sm-2">
                                  <input type="text" name="wh_lokasi" id="wh_lokasi" class="form-control" readonly>
                                  <span class="help-block"></span>
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                  <input type="text" name="qty" id="qty" class="form-control autonumeric" data-a-sep="." data-a-dec=",">
                                  <span class="help-block"></span>
                                </div>
                                ...
                                <div class="col-sm-2">
                                  <input type="text" name="units" id="units" class="form-control" readonly>
                                  <span class="help-block"></span>
                                </div>

                                <label class="col-sm-2 col-form-label">Type Trans</label>
                                <div class="col-sm-2">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                  <textarea name="noted" id="noted" class="form-control" rows="2" style="resize:vertical;"></textarea>
                                  <span class="help-block"></span>
                                </div>

                                <label class="col-sm-2 col-form-label">Tanggal FIFO</label>
                                <div class="col-sm-2">
                                  <input type="date" id="tgl_fifo" name="tgl_fifo" class="form-control" placeholder="dd-mm-yyyy">
                                  <span class="help-block"></span>
                                </div>

                                <label class="col-sm-2 col-form-label">Fifo</label>
                                <div class="col-sm-2">
                                  <select id="pilih_fifo" name="pilih_fifo" class="form-control"></select>
                                  <span class="help-block"></span>
                                </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $.ajax({
        ...
        success: function(dataBulan) {
          ...
          dataBulan.forEach(item => {
            ...
            const iconClass = iconMap[item.bentuk] || 'fa-circle'; // Pastikan menggunakan 'bentuk' dan 'warna'
      ...
      function formatOption(state) {
        ...
        return $(`<span><i class="${icon}" style="color:${color}; margin-right: 8px;"></i> ${state.text}</span>`);
      }
