                                                                ...
                                                                <table id="example"
                                                                    ...
                                                                    <thead class="bg-primary text-center">
                                                                        <tr>
                                                                            ...
                                                                            <th class="text-center" width="10%">WH
                                                                                Lokasi</th>
                                                                            <th class="text-center" width="8%">Isi Kolom
                                                                            </th>
                                                                            <th class="text-center" width="8%">Created
                                                                                Date</th>
                                                                            <th class="text-center" width="7%">Created
                                                                                By</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody></tbody>
                ...
                <div class="modal-body">
                    <form id="RegisterValidation">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="Rak" name="Rak" maxlength="50"
                                    class="form-control text-uppercase" required="required" autocomplete="off"
                  ...
                  ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="Isi" name="Isi" maxlength="4" class="form-control"
                                    required="required" autocomplete="off" placeholder="Contoh: 1, 2, 3, 4 dst.">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div id="Details">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="user" id="user" rows="3" class="form-control text-capitalize"
                                    readonly value="<?php echo strtoupper($this->session->userdata('user_name')); ?>">
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger btn-outline-danger waves-effect md-trigger"
                        onclick="reset_all()">Close</button>
