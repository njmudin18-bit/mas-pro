                              ...
                              <div class="dt-responsive table-responsive">
                                <div class="row">
                                  ...
                                  <div class="col-md-8 col-sm-12">
                                    <select name="WHLokasi" id="WHLokasi" class="form-control js-items">
                                      <option value="All" selected>All WH</option>
                                      <?php foreach ($wh as $key => $value): ?>
                                        <option value="<?php echo $value->LocationID; ?>"><?php echo $value->LocationID." - ".$value->Keterangan; ?></option>
                                      <?php endforeach ?>
                                    </select>
                                  </div>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable({
          ...
          'serverMethod': 'POST',
          'ajax': {
            url: "<?php echo base_url(); ?>laporan_rak/daftar_laporan_by_wh",
            type: 'POST',
            "data": function(data) {
              data.start_date = $('#start_date').val();
              data.end_date   = $('#end_date').val();
              data.wh_lokasi  = $('#WHLokasi').val();
            }
          },
          'aoColumns': [
            {
