                          ...
                          <div class="card">
                            ...
                            <div class="card-block">
                              <div class="dt-responsive table-responsive">
                                <div class="row">
                                  <label class="col-md-2 col-sm-12 col-form-label">Filter by date</label>
                                ...
                                <table id="order-table" class="table table-striped table-bordered nowrap" width="100%" border="1" cellpadding="0" cellspacing="0">
                                  <thead>
                                    <tr>
                                      ...
                                      <th class="text-center bg-primary">Tujuan</th>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable({
          ...
          'serverMethod': 'POST',
          'ajax': {
            url: "<?php echo base_url(); ?>laporan_rak/daftar_laporan_by_transaksi",
            type: 'POST',
            "data": function(data) {
