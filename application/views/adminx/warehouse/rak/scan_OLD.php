  ...
  <body>
                                ...
                                <form id="RegisterValidation">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-2 mt-3 mt-md-0 mt-sm-0">
                                      <input id="Unit" name="Unit" type="text" class="form-control" placeholder="Unit ID : PCS, BOX dll." readonly>
                                      <span class="help-block"></span>
                                    </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select id="Status" name="Status" class="form-control">
                    <option selected="selected" disabled="disabled">-- Pilih --</option>
                    <option value="TM">Tambah Stock</option>
                    <option value="KR">Kurangi Stock</option>
                  </select>
                  <span class="help-block"></span>
                </div>
              </div>
    ...
    <script type="text/javascript">
          ...
          $.ajax({
            ...
            success: function(hasil) {
              if (hasil.status_code == 200) {
                ...
                console.log(hasil.data.WHLokasi);
      ...
      function update_item() {
        ...
        let LabelSts  = Status == 'TM' ? 'Tambah' : 'Kurangi';
      ...
      //FUNCITON EDIT ITEMS
      function edit_item(Id, Rak, SubRak, PartID, PartName, Qty, Unit){
      ...
      $(document).ready(function() {
        ...
        $('#Status').on('change', function() {
          var selectedValue = $(this).val();
          let Text = selectedValue == 'TM' ? 'Penambah' : 'Pengurang';
