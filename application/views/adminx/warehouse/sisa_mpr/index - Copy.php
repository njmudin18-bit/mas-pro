                ...
                rowGroup: {
                    ...
                    startRender: function(rows, group) {
                        ...
                        rows.every(function(rowIdx, tableLoop, rowLoop) {
                            let data = this.data();
                            let noTrans = data.no_transaksi; // ambil dari dataset

                            if (noTrans !== null && noTrans !== '') {
                                showButton =
                                    false; // kalau ada yang sudah ada no_transaksi, jangan tampilkan button
                                return false; // stop loop
                            }
                        });

                        // bikin container row group
                        let $container = $('<div/>').append('<strong>' + group + '</strong>');
