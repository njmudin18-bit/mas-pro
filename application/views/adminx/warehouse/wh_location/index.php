  ...
  <body>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="RegisterValidation">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select id="Type" name="Type" class="form-control">
                    ...
                    <option value="PC" selected="selected">Power Cord</option>
                    <option value="WR">Wiring</option>
              ...
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">WH Location</label>
                <div class="col-sm-10">
                  <input type="text" id="WhLocation" name="WhLocation" class="form-control" required="required" autocomplete="off" placeholder="Contoh: 'WH-FG', 'WH-GRS00', 'WH-SAYUNG' dll.">
                  <span class="help-block"></span>
                  <label for="BottomText" class="text-danger font-italic" style="font-size: 12px;">Gunakan tanda kutip ' (satu). Contoh: 'WH-FG01'</label>
                </div>
              </div>
              <div class="form-group row">
    ...
    <script>
      ...
      function openModal() {
        ...
        $('.modal-title').text('Tambah WH Location'); // Set Title to Bootstrap modal title
      ...
      function closeModal() {
        ...
        $('#modal').modal('hide');
        $('.modal-title').text('Tambah WH Location');
      }
      ...
      function edit(id) {
        ...
        $.ajax({
          url: "<?php echo base_url(); ?>wh_location/wh_location_edit/" + id,
          type: "GET",
          dataType: "JSON",
          success: function(data) {
            if (data.status == 'forbidden') {
              ...
              $('[name="WhLocation"]').val(data.WhLocation);
              $('[name="Status"]').val(data.Status);
              $('#modal').modal('show');
              $('.modal-title').text('Edit WH Location');
              $('#btnSave').text('Update');
            }
      ...
      function openModalDelete(id) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: '<?php echo base_url(); ?>wh_location/wh_location_deleted/' + id,
              type: 'DELETE',
              error: function() {
      ...
      function save() {
        ...
        if (save_method == 'add') {
          url = "<?php echo base_url(); ?>wh_location/wh_location_add";
        } else {
          url = "<?php echo base_url(); ?>wh_location/wh_location_update";
        }
      ...
      $(document).ready(function() {
        table = $('#order-table').DataTable({
          ...
          "ajax": {
            "url": "<?php echo base_url(); ?>wh_location/wh_location_list",
            "type": "POST",
          },
          "aoColumns": [
            {
