...
<body>
                      ...
                      <div class="col-sm-12">
                        <div class="card">
                          ...
                          <div class="col-sm-12 mt-2">
                            <form id="trans_rack">
                              <div class="form-group row justify-content-left">
                                ...
                                <div class="col-sm-2">
                                  <select name="wh_lokasi" id="wh_lokasi" class="form-control">
                                    <option value="" disabled selected>-- Pilih --</option>
                                    <?php
                                    foreach ($wh_lokasi as $key => $value) {
                                    ?>
                                      <option value="<?php echo $value->wh_lokasi; ?>">
                              ...
                              <div class="form-group row justify-content-left">
                                ...
                                <div class="col-sm-2">
                                  <button type="button" id="btnExportExcel" class="btn btn-success mt-2 mt-md-0">
                                    Export Excel
                                  </button>
                                </div>
                              </div>
                              ...
                              <table id="order-table" class="table table-striped table-bordered nowrap" width="100%" border="1" cellpadding="0" cellspacing="0">
                                <thead>
                                  <tr class="bg-primary">
                                    ...
                                    <th class="text-center">Pindah Mapping</th>
                          ...
                          <div class=" m-2 table-responsive" style="width: 90%;">
                            <h3>Status Part</h3>
                            <table class="table table-bordered table-sm  mx-auto" style="background:#fff;">
                              <tr>
                                <td class="py-2 px-3 align-middle">
                                  <div style="background-color:#28a745; width:54px; height:24px; border-radius:4px;"></div>
                                </td>
                                <td class="py-2 px-3 align-middle">Part Bergerak kurang dari 1-2 Bulan</td>
                              </tr>
                              <tr>
                                <td class="py-2 px-3 align-middle">
                                  <div style="background-color:#ffc107; width:54px; height:24px; border-radius:4px;"></div>
                                </td>
                                <td class="py-2 px-3 align-middle">Part Bergerak kurang dari 2-3 Bulan</td>
                              </tr>
                              <tr>
                                <td class="py-2 px-3 align-middle">
                                  <div style="background-color:#dc3545; width:54px; height:24px; border-radius:4px;"></div>
                                </td>
                                <td class="py-2 px-3 align-middle">Part Bergerak kurang dari 3-6 Bulan dan seterusnya</td>
                              </tr>
                            </table>
                          </div>
                        </div>
  ...
  <!-- Modal -->
  <div class="modal fade" id="modalPindah" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-3 row ">
              ...
              <input type="text" name="id_rack_awal" id="id_rack_awal" class="col-sm-4 form-control" hidden>
              <input type="text" name="id_kolom_awal" id="id_kolom_awal" class="col-sm-4 form-control" hidden>
              <input type="text" name="wh_lokasi_awal" id="wh_lokasi_awal" class="col-sm-4 form-control" hidden>
              <label class="col-sm-4 col-form-label" for="id_rack_tujuan">Rack Tujuan</label>
              <select name="id_rack_tujuan" id="id_rack_tujuan" class="col-sm-4 form-select" required></select>
            </div>
            <div class="mb-3 row ">
              <label class="col-sm-4 col-form-label" for="id_kolom_tujuan">Kolom Tujuan</label>
              <select name="id_kolom_tujuan" id="id_kolom_tujuan" class="col-sm-4 form-select" required></select>
            </div>
            <div class="mb-3 row ">
              <label class="col-sm-4 col-form-label" for="wh_lokasi_tujuan">Lokasi Tujuan</label>
              <input type="text" name="wh_lokasi_tujuan" id="wh_lokasi_tujuan" class="col-sm-4 form-control" readonly>
            </div>
          </div>
  ...
  <div class="modal fade" id="modalTransfer" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog">
      <form id="formTransfer">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="judul_transfer">Transfer Part</h5>
          </div>
          <div class="modal-body">
            <div class="mb-3 row ">
              <input type="text" name="partid_tf" id="partid_tf" class="col-sm-4 form-control" hidden>
              <input type="text" name="id_rack_awal_tf" id="id_rack_awal_tf" class="col-sm-4 form-control" hidden>
              <input type="text" name="id_kolom_awal_tf" id="id_kolom_awal_tf" class="col-sm-4 form-control" hidden>
              <input type="text" name="wh_lokasi_awal_tf" id="wh_lokasi_awal_tf" class="col-sm-4 form-control" hidden>
              <label class="col-sm-4 col-form-label" for="id_rack_tujuan_tf">Rack Tujuan</label>
              <select name="id_rack_tujuan_tf" id="id_rack_tujuan_tf" class="col-sm-4 form-select" required></select>
            </div>
            <div class="mb-3 row ">
              <label class="col-sm-4 col-form-label" for="id_kolom_tujuan_tf">Kolom Tujuan</label>
              <select name="id_kolom_tujuan_tf" id="id_kolom_tujuan_tf" class="col-sm-4 form-select" required></select>
            </div>
            <div class="mb-3 row ">
              <label class="col-sm-4 col-form-label" for="qty_tf">QTY Transfer</label>
              <input type="text" name="qty_tf" id="qty_tf" class="col-sm-4 form-control">
            </div>
            <div class="mb-3 row ">
              <label class="col-sm-4 col-form-label" for="wh_lokasi_tujuan_tf">Lokasi Tujuan</label>
              <input type="text" name="wh_lokasi_tujuan_tf" id="wh_lokasi_tujuan_tf" class="col-sm-4 form-control" readonly>
            </div>
            <div class="mb-3 row ">
              <label class="col-sm-4 col-form-label" for="id_kolom_tujuan">Tanggal Fifo</label>
              <input class="col-sm-4 col-form-label" type="date" id="tgl_fifo" name="tgl_fifo" class="form-control" placeholder="dd-mm-yyyy">
            </div>
          </div>
          <div class="modal-footer">
  ...
  <script>
    flatpickr("#tgl_fifo", {
      ...
      onChange: function(selectedDates, dateStr, instance) {
        ...
        $('#pilih_fifo').val(namaBulan).trigger('change'); // asalkan <option value="juli">, bukan "Juli"
      }
    });
  </script>
  <script>
    ...
    $('#formTransfer').on('submit', function(e) {
      ...
      formData.push({
        name: 'tujuan_transferxx',
        value: $('#id_kolom_tujuan_tf option:selected').text()
      });

      $.ajax({
        url: '<?= base_url("warehouse_part/transfer_data") ?>',
        method: 'POST',
        data: formData,
        dataType: 'json',
        success: function(response) {
    ...
    function transfer(data) {
      ...
      $.getJSON('<?= base_url("warehouse_part/get_rack_kolom") ?>', function(data) {
        ...
        $('#id_rack_tujuan_tf').html(optionsRack);

      });

      data_array = data.split('|');
      id_rack_awal_tf = data_array[0];
      id_kolom_awal_tf = data_array[1];
      partid_tf = data_array[2];
      wh_lokasi_awal_tf = data_array[3];


      $('#modalTransfer').modal('show');
      $('#judulTransfer').text('Pindah Part ID: ' + partid_tf);
      $('#partid_tf').val(partid_tf);
      $('#id_rack_awal_tf').val(id_rack_awal_tf);
      $('#id_kolom_awal_tf').val(id_kolom_awal_tf);
      $('#wh_lokasi_awal_tf').val(wh_lokasi_awal_tf);
    }
    ...
    $('#id_rack_tujuan_tf').change(function() {
      var id_rack = $(this).val();
      $('#nama_kolom_tf').val('');
      $('#wh_lokasi_tujuan_tf').val('');
      if (id_rack) {
        $.ajax({
          ...
          success: function(data) {
            ...
            $.each(data.kolom, function(i, v) {
              html += '<option value="' + v.id_kolom + '">' + v.nama_kolom + '</option>';
            });
            $('#id_kolom_tujuan_tf').html(html);
            // Isi WH Lokasi
            $('#wh_lokasi_tujuan_tf').val(data.wh_lokasi);
          },
          error: function() {
            $('#id_kolom_tujuan_tf').val('');
            $('#wh_lokasi_tujuan_tf').val('');
          }
        });
      }
    ...
    $(document).ready(function() {
      ...
      var table = $('#order-table').DataTable({
        ...
        ajax: {
          url: '<?php echo base_url(); ?>warehouse_part/get_list_transaksi',
          type: 'POST',
          data: function(d) {
