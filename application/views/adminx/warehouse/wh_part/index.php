                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3 row ">
                            ...
                            <input type="text" name="id_rack_awal_tf" id="id_rack_awal_tf" class="col-sm-4 form-control"
                                hidden>
                            <input type="text" name="id_kolom_awal_tf" id="id_kolom_awal_tf"
                                class="col-sm-4 form-control" hidden>
                            <input type="text" name="wh_lokasi_awal_tf" id="wh_lokasi_awal_tf"
                                class="col-sm-4 form-control" hidden>
                            <label class="col-sm-4 col-form-label" for="id_rack_tujuan_tf">Rack Tujuan</label>
                            <select name="id_rack_tujuan_tf" id="id_rack_tujuan_tf" class="col-sm-4 form-select"
                                required></select>
                        </div>
                        <div class="mb-3 row ">
                            <label class="col-sm-4 col-form-label" for="id_kolom_tujuan_tf">Kolom Tujuan</label>
                            <select name="id_kolom_tujuan_tf" id="id_kolom_tujuan_tf" class="col-sm-4 form-select"
                                required></select>
                        </div>
                        <div class="mb-3 row ">
                        ...
                        <div class="mb-3 row ">
                            ...
                            <input type="text" name="wh_lokasi_tujuan_tf" id="wh_lokasi_tujuan_tf"
                                class="col-sm-4 form-control" readonly>
                        </div>
                        <!-- <div class="mb-3 row ">
