                    ...
                    success : function(data){
                        ...
                        for(i=0; i<data.length; i++){
                            html += '<tr>'+
                                    ...
                                    '<td>'+
                                        '<a href="javascript:void(0);" class="btn btn-sm btn-info item_edit" data-id="'+ data[i].id_kategori +'" data-name="'+ data[i].nama_kategori +'" data-price="'+ data[i].nama_kategori +'">Edit</a>'+
                                        '<a href="javascript:void(0);" class="btn btn-sm btn-danger item_delete" data-id="'+ data[i].id_kategori +'">Delete</a>'+
                                    '</td>'+
                                    '</tr>';
                        }
