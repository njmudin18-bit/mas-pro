        ...
        <tr>
            <td style="padding: 20px;">
                ...
                <p style="font-size: 13px; color: #333333; line-height: 1.6; margin: 0 0 20px 0;">
                    Bersama email ini, kami sampaikan bahwa **Permintaan Lembur** Anda telah **DISETUJUI**.<br>
                    Berikut adalah rincian data lembur yang disetujui, mohon jalankan sesuai jadwal yang telah ditentukan.
                </p>
                    ...
                    <tr>
                        <td width="100%" valign="top">
                            <table class="responsive-inner-table" border="1" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse; margin-bottom: 10px; border-color: #cccccc;">
                                ...
                                <tr><th width="20%" class="sub-header-cell" style="background-color: #f0f0f0;">NIP</th><td class="detail-cell">12011030044</td></tr>
                                <tr><th class="sub-header-cell" style="background-color: #f0f0f0;">Nama</th><td class="detail-cell">ANWAR BIN MADHASAN</td></tr>
                                <tr><th class="sub-header-cell" style="background-color: #f0f0f0;">Departemen</th><td class="detail-cell">EXTRUDE</td></tr>
                                <tr><th class="sub-header-cell" style="background-color: #f0f0f0;">Tanggal Lembur</th><td class="detail-cell">**[Tanggal Overtime]**</td></tr>
                                <tr><th class="sub-header-cell" style="background-color: #f0f0f0;">Waktu</th><td class="detail-cell">**[Jam Mulai]** s/d **[Jam Selesai]**</td></tr>
                                <tr><th class="sub-header-cell" style="background-color: #f0f0f0;">Total Jam</th><td class="detail-cell">**[Total Jam Lembur]**</td></tr>
                                <tr><th class="sub-header-cell" style="background-color: #f0f0f0;">Deskripsi/Notes</th><td class="detail-cell">**[Deskripsi Pekerjaan Lembur]**</td></tr>
                                <tr><th class="sub-header-cell" style="background-color: #f0f0f0;">Disetujui Oleh</th><td class="detail-cell">**[Nama Approver]** di **[Tanggal Approved]**</td></tr>
                            </table>
                        </td>
                    </tr>
                </table>
